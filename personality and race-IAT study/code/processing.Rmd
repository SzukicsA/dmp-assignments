...
for (i in seq_along(subscales)) {
  ...
  # Check completeness for each subject
  completeness_subject <- rowSums(!is.na(dat_subscale[, -1])) == num_items[i]
  
  # Store completeness information in the list
  completeness_info[[subscales[i]]] <- data.frame(subject = dat_subscale$subject, complete = completeness_subject)
}

# Print or use the completeness information as needed
