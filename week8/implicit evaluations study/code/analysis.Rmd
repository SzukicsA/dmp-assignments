...
dat_mean_amp <- data_processed_after_exclusions |>
  summarise(Mean = mean(mean_congruency, na.rm = TRUE),
            SD = sd(mean_congruency, na.rm = TRUE)) |>
  mutate(group = "Full sample")

# amp evaluations by gender category
dat_mean_amp_by_gender <- data_processed_after_exclusions |>
  group_by(group = gender) |>
  summarise(Mean = mean(mean_congruency, na.rm = TRUE),
            SD = sd(mean_congruency, na.rm = TRUE))

# combine both into one table
bind_rows(dat_mean_amp,
          dat_mean_amp_by_gender) |>
