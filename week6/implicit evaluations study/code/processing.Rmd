...
# there should be 72. I first tried it with the df data_amp_performance_criteria but that didnt work because there's already a summary
...
data_processed <- data_processed_before_exclusions |>
  mutate(exclude_participant = case_when(tolower(age) == "test" ~ "exclude",
                                         ...
                                         subject == "504546409" ~ "exclude",
                                         subject == "246532124" ~ "exclude",
                                         TRUE ~ "include"
                                           ))
